...
namespace Lab10
{
	...
	{
		// приватні поля
		private string model;           // може логічно бути null -> підміняємо "Unknown"
		private string manufacturer;    // те саме
		...
		public string Model
		{
			...
			set
			{
				if (string.IsNullOrWhiteSpace(value)) model = "Unknown";
		...
		public string Manufacturer
		{
			...
			set
			{
				if (string.IsNullOrWhiteSpace(value)) manufacturer = "Unknown";
				else manufacturer = value.Trim();
			}
		}
