...
> **Мій коментар.** Я спеціально порівнював не випадкові набори, а дані приблизно для однієї локації та одного періоду. Так можна оцінити саме різницю між джерелами і вибрати набір, який буде найбільш зручним для подальшого аналізу.
...
> **Мій коментар.** У наборі немає окремого поля дати. Конкретний день визначається комбінацією `YEAR + DOY`, чого достатньо для однозначного визначення дати та подальшого аналізу часових змін.
