...
![Шаблон проєкту у середовищі розробки](BC_screenshots/project_template_cr.png)
...
![Фінальний стан блокчейну та перевірка цільового критерію](BC_screenshots/mining_process_2_L.png)
